...
class DataManager:
    ...
    def load_tokenizer(self, model_path):
        if self.model_args.model_type in ['chatglm', 'baichuan', 'internlm', 'aquila', 'moss', 'xverse', 'mistral', 'yi']:
            ...
            tokenizer = AutoTokenizer.from_pretrained(model_path,  allowed_special='all',padding_side=self.model_args.padding_side)
            ...
            tokenizer = BloomTokenizerFast.from_pretrained(model_path,padding_side=self.model_args.padding_side)
